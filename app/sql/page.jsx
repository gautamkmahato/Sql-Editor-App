    ...
    return (
        <div className="p-6 max-w-6xl mx-auto">
            ...
            {(databases && databases.length <= 0) ? 
                <ConnectDatabaseCard handleSelectedFolder={handleSelectedFolder} />
            : <></>}
                    ...
                    <div className="mt-10">
                        <div className="bg-white p-4 rounded-lg shadow mb-6">
                            <div className="flex justify-between items-center border p-4 bg-white">
                                <div>
                                    <h2 className="text-xl font-semibold">Database: <span className='text-red-600'>{selectedDb}</span></h2>
                                    <p>No of Tables: {selectedDb.length}</p>
                                </div>
                        ...
                        {selectedTable && tableData?.length > 0 && (
                            <div className="bg-white p-4 rounded-lg shadow">
                                <h3 className="text-lg font-semibold mb-4">{selectedTable} table schema</h3>
