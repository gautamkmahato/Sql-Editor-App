...
app.prepare().then(() => {
    ...
    // Set database folder
    server.post('/api/databases/select-folder', express.json(), async (req, res) => {
        const { folderAbsolutePath } = req.body;
        console.log("express folderpath", folderAbsolutePath);

        // C:\Users\Gautam Kumar Mahato\Desktop\tts\app\databases
        // C:\Users\Gautam Kumar Mahato\Desktop\tts\demo\my-next-app\databases
    
        // DB_DIR = path.join(__dirname, folderPath);
        DB_DIR = folderAbsolutePath;
        ...
        res.json({ message: 'Database folder selected successfully', folderAbsolutePath });
    });
    
    // Set database folder
    server.post('/api/databases/select-folder', express.json(), (req, res) => {
    ...
    server.get('/api/databases', (req, res) => {
    ...
    // Create new database
    server.post('/api/databases', express.json(),  (req, res) => {
        const { name } = req.body;
        console.log(name)
        if (!name) {
    ...
    // delete database
    server.delete('/api/database/:dbName/delete', (req, res) => {
    ...
    server.get('/api/databases/:name/tables', (req, res) => {
    ...
    server.get('/api/databases/tables', async (req, res) => {
      try {
    ...
    // Create new table
    server.post('/api/databases/:name/tables', express.json(), (req, res) => {
    ...
    server.get('/api/databases/:name/table/metadata', (req, res) => {
    ...
    // Get data
    server.get('/api/databases/:name/tables/:table/data', (req, res) => {
        const dbPath = path.join(DB_DIR, `${req.params.name}.db`);
        const db = new sqlite3.Database(dbPath);
    ...
    // Get table metadata
    server.get('/api/databases/:dbName/tables/:tableName/metadata', (req, res) => {
      const dbName = req.params.dbName;
    ...
    // delete table
    server.delete('/api/database/:dbName/tables/:tableName/delete', (req, res) =>{
      const dbName = req.params.dbName;
      const tableName = req.params.tableName;
    ...
    // update table
    server.put('/api/database/:dbName/tables/:tableName/update', (req, res) =>{
      const dbName = req.params.dbName;
      const tableName = req.params.tableName;
    ...
    // execute query
    server.post('/api/database/:dbName/tables/:tableName/execute', express.json(), (req, res) =>{
      const dbName = req.params.dbName;
      const tableName = req.params.tableName;
    ...
    server.get('/api/databases/table/length', async (req, res) => {
    ...
    server.post('/api/database/:dbName/tables/:tableName/add/data', express.json(), (req, res) =>{
      const dbName = req.params.dbName;
      const tableName = req.params.tableName;
    ...
    server.delete('/api/database/:dbName/tables/:tableName/delete/data', express.json(), (req, res) =>{
      const dbName = req.params.dbName;
      const tableName = req.params.tableName;
      const {id} = req.body;
    ...
    // Get data by ID
    server.get('/api/databases/:dbName/tables/:tableName/data/:id', (req, res) => {
      const dbName = req.params.dbName;
      const tableName = req.params.tableName;
    ...
    server.put('/api/database/:dbName/tables/:tableName/update/:id', express.json(), (req, res) =>{
      const dbName = req.params.dbName;
      const tableName = req.params.tableName;
      const id = req.params.id;
